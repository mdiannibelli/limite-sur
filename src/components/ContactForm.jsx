        ...
        <div className="col-span-2">
            <label htmlFor="mensaje" className="font-tajawal font-semibold text-md md:text-lg text-white" >
                ...
                <div className="m-0 p-0 focus:outline-none">
                    <textarea name="message" required id="mensaje" rows="6" className="p-2.5 block w-full border-2 border-transparent border-white bg-transparent font-tajawal font-thin w-full  focus:outline-none"/>
                </div>
            </label>
        </div>
